 ...
 */
package NguyenLamAnh.view;

import NguyenLamAnh.model.BanDoc;
import NguyenLamAnh.model.Sach;
import NguyenLamAnh.controller.IOFile;
import java.io.File;
...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        ...
        String[] bd = {"ma Ban doc", "Ten Ban Doc", "Dia chi", "So Dien Thoai"};
    ...
    private void showBD(List<BanDoc> list) {
        tmBD.setRowCount(0);
        for (BanDoc i : list) {
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Ma Sach:");

        jLabel15.setText("Ma Ban Doc:");
        ...
        jLabel17.setText("Sap xep theo:");

        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ten ban doc", "So luong cuon sach duoc muon" }));
        ...
        jTabbedPane1.addTab("Quan Ly", jPanel5);
        ...
        jTabbedPane1.addTab("Quan Ly", jPanel7);
