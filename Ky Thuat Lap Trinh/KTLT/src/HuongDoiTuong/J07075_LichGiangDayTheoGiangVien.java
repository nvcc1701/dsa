...
public class J07075_LichGiangDayTheoGiangVien {
    ...
    public static class NhomLopHoc implements Serializable {
        ...
        @Override
        public String toString() {
            String s = manhom + " " + tenmon + " " + ngaygiangday + " " + kiphoc + " " + phonghoc;
            return s;
        }
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        while (t1-- > 0) {
            MonHoc mh = new MonHoc(sc1.nextLine().trim(), sc1.nextLine().trim(), sc1.nextLine().trim());
        ...
        for (NhomLopHoc nlh : lst) {
            if (nlh.hotengv.equalsIgnoreCase(key)) {
                nlh.tenmon = map1.get(nlh.mamon);
